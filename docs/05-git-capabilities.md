# ⏰ [已歸檔] Git-Capabilities.md 舊版本
## 此文件已被 docs/GIT-CAPABILITIES.md 取代

| 檔案名 | 狀態 | 日期 | 說明 |
|--------|------|------|------|
| docs/05-git-capabilities.md | ❌ 已歸檔 | - | 舊版本，已移至 GIT-CAPABILITIES.md |

**➡️ 請使用新檔案:** `docs/GIT-CAPABILITIES.md` (10.3KB, v0.6.0 Release)  
